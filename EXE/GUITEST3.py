...
def scan():
    ...
    def run():
        print("Value of cam: ",camscr)
        Main.reading(numques,numchoices,ans_ind,checkbox_vars[0].get(),checkbox_vars[1].get(),checkbox_vars[2].get(),checkbox_vars[4].get(),checkbox_vars[3].get(),camscr)
...
def submit_form():
    ...
    _dict = {"WebCam":0,"WebCam1":1,"WebCam2":2,"WebCam3":3,"WebCam4":4,"WebCam5":5}
    camscr = _dict[_scr]
    print(camscr)
...
options = ["WebCam", "WebCam1","WebCam2","WebCam3","WebCam4","WebCam5"]
